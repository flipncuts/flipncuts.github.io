...
<div class="container">
		...
		<div id="main" class="col-xs-12 col-sm-12">
			...
			<div id="main-content" class="col-xs-12 col-sm-12 slider-wrapper theme-default">
				<div id="slider" class="col-lg-12 col-sm-12 col-md-12 nivoSlider">
				...
				<div id="content" class="col-xs-12 col-sm-12 col-md-12">
					<div id="welcome" class="col-lg-12 col-sm-12 col-md-12">
						<h3 style="color:rgb(98, 98, 218)">ABOUT US</h3>
							<p>
							...
							<p>
								By being years of pet grooming teachers,  pet stylists, and pet trainers in Taiwan, we know the needs of pet owners, and the requirements of pets. Also, with years of experience to work with dogs and cats in Taiwan, Asia and US, we understand the specific charateristic of each pet breed. " Understand the animal before groom it. ", we are confident of  providing your babies the top services. 
							</p>
							<p>							
							...
							<div class="col-lg-6 col-sm-6 col-md-6">
								<img src="IMG_3450.jpg" width="500" class="img-responsive"/>
							</div>
							<div class="col-lg-6 col-sm-6 col-md-6">
								<img src="IMG_3451.jpg" class="img-responsive"/>
							</div>
